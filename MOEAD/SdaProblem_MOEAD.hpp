#ifndef FORMUHAMET_SDAPROBLEM_MOEAD_HPP
#define FORMUHAMET_SDAPROBLEM_MOEAD_HPP
...
struct sda_problem_moead {
    ...
    sda_problem_moead(int nodes = 256, int states = 12, int runs = 5, bool totInfcost = false)
    ...
    std::vector<double> fitness(const std::vector<double> &x) const {
        ...
        // add genes
        const_cast<sda_problem_moead*>(this)->applyGenesToSDA(sda, x);
